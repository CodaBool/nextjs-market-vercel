/* TODO:
- error handling
- fade in, show categories message after touched */
...
import { axios, CATEGORY } from '../constants'
...
export default function admin() {
  ...
  function getProducts(filterInactive) {
    axios.get('/api/stripe/admin/getProducts', { params: { filterInactive }})
