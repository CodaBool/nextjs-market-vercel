...
export default function NavBox() {
  ...
  return (
    <div className="navBox">
      ...
      <a href="https://github.com/CodaBool/nextjs-market-heroku" ref={code} className="navBox-btn" id="btn-code" onMouseEnter={() => expand(imgCode)} onMouseLeave={() => contract(imgCode)}>SEE CODE</a>
